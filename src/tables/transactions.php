...
function displayTransactions($transactions)
{
  if (!empty($transactions)) {
    ...
    foreach ($transactions as $transaction) {
      ...
      echo "<td>";
      echo "<a href='/src/actions/update/update_transaction.php?id=" . htmlspecialchars($transaction['transaction_id']) . "' class='btn btn-dark '>Edit</a> ";
      echo "<a href='/src/actions/delete/delete_transaction.php?id=" . htmlspecialchars($transaction['transaction_id']) . "' class='btn btn-danger '>Delete</a>";
      echo "</td>";
      echo "</tr>";
    }
    echo "</tbody>";
